...
All copy below uses Kit's voice (warm, direct, theatre-trained, UK English).
...
Three things I'd ask you to think about between now and then:

1. What does the relationship you actually want look like? Specifics. Not "a good guy." What does a Tuesday night with him look like.
2. What's been the gap between that and what you've been finding? Be honest with yourself.
3. What do you think is in the way?

Bring your answers to the call. I'll show you what I see, and we'll figure out together if what I do is the right vehicle for getting you there.
...
Good chat earlier. Thanks for your honesty about [SPECIFIC THING SHE SAID].
...
1. You're in, just haven't filled the form
2. You're not, but you don't want to say it
3. You're somewhere in between and need another conversation
...
Wrapping up the loop on our chat.

If you're ready to move forward, link is here: [ONBOARDING LINK]

If timing's not right, also fine. I'll close your application out, no hard feelings, and the door's open if it shifts in 3-6 months.

If you want, I can also recommend someone better suited for where you're at right now. Just say the word.
...
Quiz result attached. You're a [ARCHETYPE].

Quick read on what that means:

- Your strength: [STRENGTH]
- Your blindspot: [BLINDSPOT]
- The shift that changes everything: [SHIFT]

Over the next 10 days I'm going to send you the most useful stuff I've ever written for women in your situation. Mostly free. Some about how I work.
...
## What This Sequence Does Together

| Sequence | Purpose | Volume / month |
|---|---|---|
| Pre-call nurture | Show rate floor at 80% | 9-15 prospects |
| Post-call follow-up | Convert undecided into closed deals | 4-6 prospects |
| 10-day welcome | Convert quiz subs into course / 1:1 buyers | 200-500 subs |

Stack of all three = predictable revenue layer on top of the funnel.
